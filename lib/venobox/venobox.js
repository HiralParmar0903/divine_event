        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                function loadVid(autoplay) {
                  var player;
                  var videoObj = parseVideo(dest); // `dest` must contain the video URL.
              
                  // Optional autoplay query parameter
                  var stringAutoplay = autoplay ? "?autoplay=1" : "";
              
                  if (videoObj.type === 'vimeo') {
                      player = 'https://player.vimeo.com/video/';
                      content.html('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="' + player + videoObj.id + stringAutoplay + '"></iframe>');
                  } else if (videoObj.type === 'youtube') {
                      player = 'https://www.youtube.com/embed/';
                      content.html('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="' + player + videoObj.id + stringAutoplay + '"></iframe>');
                  } else if (videoObj.type === 'local') {
                      // For local videos
                      player = videoObj.id; // Use the full path provided for local videos
                      content.html('<video class="venovideo vbvid" controls autoplay' + (autoplay ? ' autoplay' : '') + '><source src="' + player + '" type="video/mp4">Your browser does not support the video tag.</video>');
                  }
